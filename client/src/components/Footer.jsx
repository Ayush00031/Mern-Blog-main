    ...
    <Footer container className="border border-t-8 border-teal-500">
       ...
       Blog
                ...
                <div className="grid grid-cols-2 gap-8 mt-4 sm:grid-cols-3 sm:gap-6">
                    ...
                    <Footer.LinkGroup col>
                        <Footer.Link href="https://www.github.com/ayush00031"
                        target="_blank"
                        rel="noopener noreferrer"
                        >
                            GitHub
            ...
            <div className="w-full sm:flex sm:items-center sm:justify-between">
                <Footer.Copyright href="#" by="ABC blog" year={new Date().getFullYear()} />
            <div className="flex gap-6 sm:mt-0 mt-4 sm:justif-center">
                ...
                <Footer.Icon href="https://github.com/ayush00031" icon={BsGithub} />
